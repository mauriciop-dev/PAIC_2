      ...
      <div className="bg-white rounded-xl shadow-sm border p-6 max-w-2xl">
        ...
        {actual ? (
          <dl className="space-y-3">
            <div className="flex justify-between"><dt className="text-gray-500">Nombre</dt><dd className="font-medium">{actual.name}</dd></div>
            <div className="flex justify-between"><dt className="text-gray-500">Dirección</dt><dd>{actual.address ?? "—"}</dd></div>
